package com.brandonmiller355.zeldaocarinatabs
...
import com.brandonmiller355.zeldaocarinatabs.Fragments.SongDetailFragment
...
class SongListActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(recyclerView: RecyclerView) {
        recyclerView.adapter = SimpleItemRecyclerViewAdapter(this, SongItemContent.ITEMS, twoPane)
    }

    class SimpleItemRecyclerViewAdapter(private val parentActivity: SongListActivity,
                                        private val values: List<SongItemContent.SongItem>,
        ...
        init {
            onClickListener = View.OnClickListener { v ->
                val item = v.tag as SongItemContent.SongItem
                if (twoPane) {
